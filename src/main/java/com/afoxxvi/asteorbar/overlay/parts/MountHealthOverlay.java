...
public class MountHealthOverlay extends BaseOverlay {
    private void draw(PoseStack poseStack, int left, int top, int right, int bottom, float health, float healthMax, boolean flip) {
        ...
        GuiHelper.drawTexturedRect(poseStack, left, top, right, bottom, 9, Y_MOUNT_HEALTH_BAR, 182, 5);
        drawTextureFillFlip(poseStack, left + 1, top, right - 1, healthWidth, 5, 10, Y_MOUNT_HEALTH_FILL, flip);
    }
